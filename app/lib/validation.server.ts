...
// Esquemas de validación de formularios. Se parsean en las actions (server-side);
// los mensajes de error son para el usuario final.
...
export const productSchema = z.object({
  ...
  priceCents: z.coerce.number().int().nonnegative("Ingresá el precio."),
  imageUrl: optionalText,
  stock: z.coerce.number().int().nonnegative("El stock no puede ser negativo."),
  leadTimeDays: optionalText.transform((value) => (value ? Number(value) : null)),
